 ...
 */
public abstract class LogOutputBufferStream extends OutputStream {
    ...
    /**
     * Logs a line buffer to the log system of the user.
     *
     * @param buffer the line buffer to log.
     */
    protected abstract void processLine(ByteArrayOutputStream buffer);
