...
public class MybatisObjectHandler implements MetaObjectHandler {
    ...
    public void setFieldValIfNull(String field, Object fieldVal, MetaObject metaObject) {
    ...
    public void updateFill(MetaObject metaObject) {
        //更新时 需要填充字段
        Stream.of("updatedTime").forEach(s -> setFieldValIfNull(s, new Date(), metaObject));
