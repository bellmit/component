...
public class ScanbuyTest {
    ...
    private static void store() {
        ...
        final ActivityCO activityDO = JSONUtil.toBean(requestBody, ActivityCO.class);
        System.out.println(JSONUtil.toJsonPrettyStr(activityDO));
        ...
        commonTypeItemList.stream()
                .filter(itemCo -> itemCo.getItemKey().equals(ScanbuyTypeItem.scanbuyBasicQrCodeContentShow.name()))
                .findFirst()
                .ifPresent(System.out::println);


        System.out.println("转换成DO list----------");
        final List<ScenarioItemEntity> itemDOList = commonTypeItemList.stream()
                .map(itemCo -> {
        ...
        System.out.println(JSONUtil.toJsonPrettyStr(itemDOList));
        ...
        System.out.println(JSONUtil.toJsonPrettyStr(configMap2));
        ...
        System.out.println(JSONUtil.toJsonPrettyStr(itemKeyValueMap2));
